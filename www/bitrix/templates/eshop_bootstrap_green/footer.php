...
<?if ($APPLICATION->newTitle){
	$APPLICATION->SetPageProperty('title', $APPLICATION->newTitle);
}
if ($APPLICATION->newDescr){
	$APPLICATION->SetPageProperty('description', $APPLICATION->newDescr);
}?>
